...
package com.example.barcodemlkit.barcodedetection

import android.animation.ValueAnimator
import android.util.Log
import androidx.annotation.MainThread
import com.google.android.gms.tasks.Task
import com.example.barcodemlkit.InputInfo
import com.example.barcodemlkit.camera.CameraReticleAnimator
...
import com.example.barcodemlkit.camera.FrameProcessorBase
import com.example.barcodemlkit.settings.PreferenceUtils
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            if (sizeProgress < 1) {
                ...
                // [START UNCOMMENT HERE FOR DELAY]
